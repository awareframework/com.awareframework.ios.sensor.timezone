...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of com.awareframework.ios.sensor.timezone.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/tetujin/com.awareframework.ios.sensor.timezone'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'tetujin' => 'tetujin@ht.sfc.keio.ac.jp' }
  s.source           = { :git => 'https://github.com/tetujin/com.awareframework.ios.sensor.timezone.git', :tag => s.version.to_s }
